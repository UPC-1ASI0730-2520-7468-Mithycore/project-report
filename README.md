...
| Criterio específico | Acciones realizadas | Conclusiones grupales (acumulativas) |
|----------------------|---------------------|--------------------------------------|
| **Trabaja en equipo para proporcionar liderazgo en forma conjunta** | **Stanley Jeremy Gutiérrez Tume** — **TB1:** facilitó acuerdos de trabajo (roles, DoD), dirigió las ceremonias iniciales, creó el repositorio en GitHub y promovió liderazgo distribuido por frentes (UX, backend, LP).<br>**Juan José Meza Huanacune** — **TB1:** co-lideró la definición de **GitFlow** y de las **convenciones de commits**, supervisó la configuración del backend y guió el proceso de *pull requests*.<br>**Eduardo Fabián Chacaliaza Minaya** — **TB1:** lideró el frente **UX/UI**, coordinó revisiones de diseño y mantuvo la coherencia visual basada en **Material Design** y **PrimeVue**.<br>**Fabricio Fabián Quispe Barzola** — **TB1:** lideró la **definición del problema** mediante el método **5W2H**, alineando el alcance del proyecto con la visión del equipo.<br>**Romero Meza Jhimy Pool** — **TB1:** diseñó la **estructura y contenido del Landing Page**, articulando comunicación entre los frentes de UX y backend. | **TB1:** El liderazgo fue **distribuido** entre los integrantes, favoreciendo la toma de decisiones conjunta. Se definieron responsabilidades, flujos de trabajo (GitFlow) y lineamientos técnicos que establecieron una base sólida para el trabajo colaborativo. En los siguientes hitos (**TP1**, **TB2**, **TF1**) se agregará evidencia adicional sobre el liderazgo compartido. |
| **Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos** | **Stanley Jeremy Gutiérrez Tume** — **TB1:** definió los objetivos del sprint, estableció un cronograma de reuniones y promovió la participación equitativa.<br>**Juan José Meza Huanacune** — **TB1:** configuró **issues, labels y tablero**, estableció los criterios **DoR/DoD** y normalizó las pautas de colaboración.<br>**Eduardo Fabián Chacaliaza Minaya** — **TB1:** definió criterios visuales y de accesibilidad (**a11y/i18n**) y los aplicó en el diseño del Landing Page.<br>**Fabricio Fabián Quispe Barzola** — **TB1:** propuso herramientas colaborativas para documentación y entrevistas, estandarizando las plantillas de registro.<br>**Romero Meza Jhimy Pool** — **TB1:** implementó componentes del Landing Page y organizó los recursos visuales compartidos para optimizar el trabajo conjunto. | **TB1:** El equipo creó un entorno **colaborativo e inclusivo**, con reglas claras (**DoD/DoR**) y un backlog visible. Se cumplieron los objetivos del sprint: creación del repositorio, desarrollo del Capítulo I y despliegue inicial del Landing Page. En próximas entregas se incluirán los avances y resultados de las metas planificadas. |
...
| ![Eduardo](img/eduardo.jpg) | **Eduardo Fabián Chacaliaza Minaya (U202324129)** | **Frontend & UX/UI Engineer (PrimeVue / Figma)** | Dirige el diseño de la interfaz y la experiencia de usuario. Responsable de la creación del **design system**, la accesibilidad (**a11y**) y la internacionalización (**i18n**, en_US/es_419). Utiliza **Figma** y **PrimeVue** para garantizar consistencia visual. <br>**Evidencia TB1:** diseño inicial del Landing Page y lineamientos visuales aplicados al prototipo. |
...
- Existen soluciones consolidadas (Mon4t, BioSerenity, Empatica, PDMonitor, etc.) que validan la viabilidad técnica y clínica del enfoque. Estas referencias permiten aprender sobre diseño hardware-software, validación clínica y cumplimiento normativo; también evidencian áreas de oportunidad (integración multi-sensor, tests cognitivos remotos, mayor cobertura de enfermedades).  

- El backlog inicial es adecuado como primer MVP, pero requiere ampliación: se estimó un backlog realista de 40–50 historias para cubrir casos de conexión, errores, usabilidad, seguridad, roles adicionales y pruebas técnicas (logging, escalabilidad, rate limits, i18n). Se recomendó aplicar INVEST y priorizar con MoSCoW.  
